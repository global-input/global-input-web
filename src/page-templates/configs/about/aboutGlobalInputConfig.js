        ...
        signInDevice:{
            ...
            ["The fastest way of trying this out is to load the ",
                 ...
                 ". Click on the \”Next” button on the ",
                   {type:"link",content:"sample web application",link:pagelinks.samples.formData.link},
                   ", and then scan the QR Code with your Global Input App on your mobile. The same form being displayed on your computer screen should be displayed on your mobile as well, allowing you to use your mobile to enter content on the form displayed on your computer. You can now save the form data on your mobile before ending the session for future use.",
                   "Now If you reload the page and go through the process again, you will notice that a button named “Matched” has appeared on the bottom of your mobile screen. This means that one or more data items in your app matches the form displayed by the application. If you press the button, a list of matched data items will be shown. Normally you have only one item in the list. When you select the data item by pressing on it, you will be presented with the detail page of the data item. The value of the fields will still be displayed with “*” characters, which means that the value is not decrypted yet.  You can press the \”Show\” button to decrypt and reveal its content, or you can press the “Select” button straightaway to decrypt the data and send it to the form on your computer. Now you can select the field and then click on the “Copy” button to copy the content into you clipboard, and switch to the application you need and paste the content there."
                 ],
