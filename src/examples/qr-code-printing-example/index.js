...
import {GlobalInputConnect,DisplayQRCode} from 'global-input-react';
...
renderReceivingEncryptedContent(styles){
  return(
    <React.Fragment>
          ...
          <div style={styles.help}>Please operate on your mobile to create an Encrypted QR Code:
                <ul>
                    <li>Press the 'Encrypt' button on your mobile if you would like to backup a confidential message/password.
                    </li>
                    <li>
                      Press the 'Key' button on your mobile if you would like to backup one of your encryption keys.
                    </li>
                    <li>
                      Press the "Settings" button on your mobile if you would like to backup your app settings
                    </li>
