...
export default class SecureTransferData extends React.Component{

  static menu={
        id:"secureTransfer",
        label:"Secure Transfer Data",
        title:"Secure Transfer Data"
  }
  render(){
    return(
      <div style={styles.chapter.container.get()} id={SecureTransferData.menu.id}>
          <div style={styles.chapter.title.get()}>
                {SecureTransferData.menu.title}
          </div>
          <div style={styles.chapter.content.get()}>
                <div style={styles.chapter.paragraph}>
                    Transfering content between user mobile and applications securely and allowing user to save and load the data on-demand is an attractive option when it comes to using personal data or other sensitive information.
                </div>
                <div style={styles.chapter.paragraph}>
