  ...
  return (
    <Page selected={config.paths.privacy.path}>
      ...
      <PageContainer>
        ...
        <P>
          Your data in your mobole app always stays encrypted and decrypted only at the point of usage.  The keys used in the encryption never leave your mobile and are encrypted with a memorable password.  This means that you are responsible for backing up your encryption keys in your mobile app and the data that are encrypted with the encryption keys.  Since you can export an encryption key as encrypted QR code, and import it simply by scanning it,  the process of backing up the keys and sharing between your devices is a straightforward operation.
</P>
