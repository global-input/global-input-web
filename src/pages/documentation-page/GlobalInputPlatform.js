...
<FirstSection>
              ...
              The platform enables the mobile device and the web application to transfer data securely and provides a wide range of functions:
               ...
               Please install the app and explore the following use cases in action. You may find many reasons why the app can become an essential tool in a corporate environment. If you are interested in how it works and would like to extend your web applications to allow users to use their mobi le to operate on them, please visit the platform page.
                </P>
