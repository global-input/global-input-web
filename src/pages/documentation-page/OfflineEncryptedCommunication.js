...
<FirstSection>
              ...
              <P>
              You can establish encrypted offline communication with a Global Input App user by pre-sharing one of the managed encryption keys in your app. It is called offline because the network communication is not required for transferring the data.
              </P>
              <P>
Having pre-shared the encryption key, you can use it to encrypt content and create an encrypted QR code. You can print out the encrypted QR code, or send the image or share it via a video link with the other party to transfer the confidential content. You can do this even in a video conference knowing that only the person, who has shared the encryption key with you, can see the content via his/her mobile screen.
              </P>

              <P>
              <Title2>Arching Passwords</Title2>
              This is also useful if you have the habit of writing down confidential information on a piece of paper. In some companies, the root passwords for some systems are not normally used in day-to-day operations, so they are written down in a paper and stored in a safe box. With the Global Input App, you can just print out the root passwords as an encrypted QR code and nobody else can decrypt the content unless you have shared the encryption key with them.
              </P>
              <P>
              ...
              Let’s say you would like to set up an offline encrypted communication between your current phone and a new phone, and you have installed the Global Input App on both.
              </P>
              ...
              Now if you scan the QR code with the Global Input App on your new mobile, a form for importing the encryption key will be displayed, where you need to type in the password to decrypt the encryption key. If the password is correct, the app will be able to decrypt the encryption key and import it into the app.
After this, an offline encrypted communication will be established between these two mobiles.
              ...
              Now if you press the “+” button on the “Encrypt” tab of your Global Input App, you can enter content to encrypt and then select the encryption key you have just shared/imported. When you press the encrypt button, a QR code will be displayed on your mobile screen. If you scan it with your new mobile, you will see the decrypted content on your mobile screen, and you can press the ”Copy” button to copy the content into your clipboard.
              </P>

              <P>
              <Title2>Print QR Codes on Computer</Title2>
              Load the sample web application with your browser running on your computer.
If you scan the QR code displayed there, a form will be displayed on your mobile screen that is for creating a QR code. You can now send an encrypted content from your mobile to the content field of your form on your computer. Press the "Encrypt" button on your bottom of your mobile screen to create an encrypted content and send it to the form displayed on your screen. Then you can press the <Concept>Print</Concept> button to print the QR code.
