  ...
  home:{
     ...
     universalApp:{
        ...
        content:[
          ...
          "This brings the mobile app environment into your service application running on other devices such as Computers, Smart TV etc. For operate on your chrome browser, please download the [chrome extension](https://chrome.google.com/webstore/detail/global-input-app/hcklienddlealndjnakkagefaelhnjkp?hl=en) and so that you can use your mobile automatically sign in to the websites and the web applications that are loaded into your chrome browser.  You can also visit  [our documentations](/global-input-app/documentation) for more information."
        ]
     },
     endToEnd:{
