const textValues={
  ...
  home:{
     ...
     content1:["If you have service applications running on computers, Smart TVs, Set Top Boxes or IoT devices,  and you would like to allow your users to use their mobile to operate them just by pointing their phone camera to a QR code, you have come to the right place. ",
        ...
        "If you already have the Global Input mobile app on your mobile and are visiting this website with your computer, you can click on the example scenarios listed below and try it out with your mobile.",
        "If you have already tried the examples listed below, you may play around with the code yourself with [this example]( https://jsfiddle.net/dilshat/26jh68wv/). ",
        ...
        "If you install [this Chrome extension](https://github.com/global-input/chrome-extension), you will be able to use the Global Input App on the Jira, Confluence or GitLab business applications.",
