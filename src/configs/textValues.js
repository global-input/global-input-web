const textValues={
  ...
  home:{
     ...
     content1:["The Global Input open-source software enables service applications running on computers, Smart TVs, or any other devices to transfer some activities securely to the mobile app to allow users to operate with their mobile devices. The communication between them is established by using the end-to-end encryption and the keys are passed over to the mobile app via the mobile phone's camera.",
