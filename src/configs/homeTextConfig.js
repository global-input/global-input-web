const  homeTextConfig={
    application:{
      ...
      appDownload:{
       ...
       chromeExtension:{
          content:"If you would like use your mobile to operate on the Sign In forms in the web pages that are being displayed on your computer screen, you can install ",
          linkText:"the Global Input App Chrome Extension",
          linkURL:"https://chrome.google.com/webstore/detail/global-input-app/hcklienddlealndjnakkagefaelhnjkp",
          content2:" from the Chrome Web Store."
       }
    },
    contentTransfer:{
