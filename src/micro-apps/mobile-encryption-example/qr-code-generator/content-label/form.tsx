...
export const ContentInput = ({ content = '', onContentChanged, expand, setExpand }) => (
  <Field>
    <TextArea
      ...
      value={content || ''} // Ensure value is always a string
    ...
    <Help expandId={CONTENT_ID} expand={expand} setExpand={setExpand}>
      The encrypted content received from your mobile app will be displayed in the text box above. Note that only your
      mobile app can decrypt the data. This application uses the encrypted data received to create an encrypted QR code
      in the next step.
    </Help>
  </Field>
);
...
export const LabelInput = ({ label = '', onLabelChanged, expand, setExpand }) => (
  <Field>
    <Input
      ...
      value={label || ''} // Ensure value is always a string
    ...
    <Help expandId={LABEL_ID} expand={expand} setExpand={setExpand}>
      This will be placed above the QR Code as a label to help you identify it. This is especially useful when printing
      the encrypted QR codes for filing purposes.
    </Help>
  </Field>
);