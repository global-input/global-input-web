...
var GlobalInputConnect = function (_Component) {
  ...
  _createClass(GlobalInputConnect, [{
    ...
    value: function renderError() {
      ...
      return _react2.default.createElement(_displayQrcode2.default, { code: this.state.message, label: this.state.message, size: this.props.qrCodeSize });
    }
  }, {
    ...
    value: function renderConnected() {
      ...
      return _react2.default.createElement(_displayQrcode2.default, { code: this.state.code, label: this.props.connectedMessage, size: this.props.qrCodeSize });
    }
  }]);
